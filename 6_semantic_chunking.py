...
# Semantic Chunker - groups by meaning, not structer
...
smeantic_splitter = SemanticChunker(
    embeddings=embedding_model,
    breakpoint_threshold_type="percentile",   # or "stanrdard_deviation"
    breakpoint_threshold_amount=70  # percentile value (0-100) 
)

chunks = smeantic_splitter.split_text(tesla_text)
